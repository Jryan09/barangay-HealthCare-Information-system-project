...
<div class="read-wrap1">
    ...
    if (isset($_GET['id'])) {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            echo "<span> Patient Name:</span> <h5>{$row1['patient_name']}</h5><br>";
            echo "<span>Vaccination name: </span><h5>{$row1['vaccine_name']}</h5><br>";
            echo "<span>Vaccination Date </span><h5>{$row1['vaccination_date']}</h5><br>";
            echo "<span>Vaccination Provider </span><h5>{$row1['health_provider']}</h5><br>";
            echo "<h5 class='h5-l'><a class='r-link1' href='immunization.php'>Back to List</a ></h5>";
            echo "<h5><a class='r-download1'  href='immunization_download.php?id= $id; '><img src='svg/download.gif' alt='' style='width: 50px; height:50px; margin: auto auto;'></a></h5>";
